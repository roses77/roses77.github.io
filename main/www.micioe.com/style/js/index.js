...
$(function () {
	...
	*/
	...
	//timer22=setInterval(auto,2000);
 $(".carousel").owlCarousel({"items": 1, autoPlay: true});
   var carouselCase = $(".carousel-case").owlCarousel({"items": 1, "pagination": false, 'addClassActive': true});
     var carouselLive = $(".carousel-live").owlCarousel({"items": 4});
      /*   $(".carousel-game").owlCarousel({"items": 4});
    $(".carousel-business").owlCarousel({"items": 4});
      $(".carousel-travel").owlCarousel({"items": 4});*/
      $(".carousel-percent").owlCarousel({"items": 4, autoPlay: true});   
    $(".carousel-percent .owl-pagination").hide();
    var carouselMap = $(".carousel-map").owlCarousel({"items": 1, "pagination": false});
    //首页地图
    $(".contact .nav  li").click(function(){
    	$(this).addClass("current").siblings().removeClass("current");
    	var index=$(this).index();
    	$(".carousel-mapa div").eq(index).show().siblings().hide();
    	
    });
    
    $(".carousel-left-btn").click(function () {
        var activeCarousel = $('.carousel-case .owl-item.active').find('.owl-carousel');
        carouselLive.trigger('owl.prev');
    });

    $(".carousel-right-btn").click(function () {
        var activeCarousel = $('.owl-item.active').find('.owl-carousel');
        activeCarousel.trigger('owl.next');
    });

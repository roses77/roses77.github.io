$(function(){
	...
	var movingDistance	    = 900;//每次移动的距离
	var curWidth			= 930;//当前中间li的宽度为350px
	var curHeight         =312;//当前中间li的高度未312  
	var curImgWidth  =230;
	var curImgHeight  =288;
	var othersW           =900;//其他li的宽度
	var othersH           =235;//高度
	var othersImgW           =870;//其他li的宽度
	...
	$container.css('width', (($panels[0].offsetWidth+0) * $panels.length) + 10 ).css('left','0');//计算容器的总的宽度 PS：25为margin值 offsetWidth

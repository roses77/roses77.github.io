...
/*! umeng_index - v0.0.1 - 2015-11-18 */function hideTabBar(){var a=$(this).scrollTop();$("#nav-footer").animate({bottom:a-lastScrollTop>0?"-60px":"0px"},200),lastScrollTop=a}function renderStreamChartLine(a){a.append("g").attr("class","custom-line").selectAll("custom-ticks").data(d3.range(7)).enter().append("line").attr("x1",function(a,b){return 166.666666*b}).attr("y1",function(a,b){return 0}).attr("x2",function(a,b){return 166.666666*b}).attr("y2",function(a,b){return 600}).attr("stroke","#fff").attr("stroke-opacity",.6).attr("stroke-dasharray","2").attr("stroke-width","1")}function shareTo(a,b){var c={url:"http://www.umindex.com",summary:"友盟指数",title:"友盟指数 #友盟指数#",pic:"http://0.0.0.0:3000/social",appkey:{weibo:"2450105505",tencent:"801345073"}},d=$.extend(!0,{},c,b||{});switch(d.summary=encodeURIComponent(d.summary),d.url=d.url+"?s="+a,a){case"qzone":d.url=encodeURIComponent(d.url);var e="http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url="+d.url+"&title="+d.title+"&pics="+d.pic+"&summary="+d.summary;window.open(e,"_blank");break;case"weibo":d.url=encodeURIComponent(d.url);var e="http://service.weibo.com/share/share.php?appkey="+d.appkey.weibo+"&title="+d.summary+"&url="+d.url+"&pic="+d.pic;window.open(e,"_blank");break;case"tencent":d.url=encodeURIComponent(d.url);var e="http://share.v.t.qq.com/index.php?c=share&a=index&title="+d.summary+"&url="+d.url+"&appkey="+d.appkey.tencent+"&site=www.umindex.com&pic="+d.pic;window.open(e,"_blank");break;case"weixin":$("body .qrcode").remove(),$("body").append("<div class='qrcode'><span class='closeBtn'>x</span><div id='qrcode'></div>扫描二维码分享到微信</div>"),jQuery("#qrcode").qrcode({text:d.url,width:145,height:145}),$(".qrcode").fadeIn(300,function(){$(".qrcode").click(function(){$(".qrcode").fadeOut(300,function(){$(".qrcode").remove()})})})}}$(".drop-item").on("click",function(a){a.stopPropagation(),$(".page-nav-sub").not($(this).find(".page-nav-sub")).hide(),$(".page-nav-sub",$(this)).toggle()}),$(document).on("click",function(a){$(".page-nav-sub").hide(),$(".pop").hide()});var lastScrollTop=0,isScrolled;$(window).on("scroll",function(){isScrolled=!0}),setInterval(function(){isScrolled&&(hideTabBar(),isScrolled=!1)},300),$("#btn-nav-menu").off().on("click",function(a){a.preventDefault(),$("#index-cate").toggle()}),function(a){a.fn.loadStart=function(b){b||(b={});var c=a.extend({"min-top":55,"max-top":null},b);a(this).each(function(b,d){var e=a("<div class='loading'></div>").append("<div class='circle'></div>").appendTo(a(d)),f=e.height()/2-e.find(".circle").height()/2;f=f<c["min-top"]?c["min-top"]:f,f=null===c["max-top"]?f:f>c["max-top"]?c["max-top"]:f;var g=e.width()/2-e.find(".circle").width()/2;e.find(".circle").css("top",f+"px").css("left",g+"px"),e.fadeIn("slow")})},a.fn.loadEnd=function(){a(this).each(function(b,c){a(c).find(".loading").fadeOut("slow",function(){a(this).remove()})})}}(jQuery),$(window).width()<1024&&$(".shareButton").hide(),$(".shareButton li").on("click",function(){var a=new Date;a.setMonth(a.getMonth()-1);var b=d3.time.format("%Y-%m")(a),c={devices:{url:"http://"+window.location.host,summary:"#友盟指数# 及时准确地呈现移动互联网行业数据，帮助您了解行业现状、预测未来趋势、发现新机遇。",title:"设备指数 #友盟指数#",pic:"http://"+window.location.host+"/images/socialcasts/months/"+b+"/devices.png"},social:{url:"http://"+window.location.host+"/social",summary:"#友盟社交指数# 以简洁直观的全新数据可视化方式呈现移动分享和登录的相关数据，帮助您及时了解移动社交的相关指数。",title:"APP内社交数据 #友盟社交指数#",pic:"http://"+window.location.host+"/images/socialcasts/months/"+b+"/social.png"},um_indices:{url:"http://"+window.location.host+"/app",summary:"#友盟应用指数# 以简洁直观的全新数据可视化方式呈现移动应用的发展趋势，帮助您及时了解不同类型应用每日的安装和活跃指数。",title:"应用安装及活跃指数 #友盟应用指数#",pic:"http://"+window.location.host+"/images/socialcasts/months/"+b+"/app_index_installation_android.png"},markets:{url:"http://"+window.location.host+"/markets",summary:"#友盟市场指数# 简洁直观地呈现App在各大软件商店的下载情况，帮助您及时了解App市场分发的相关数据。",title:"App市场分发数据 #友盟市场指数#",pic:"http://"+window.location.host+"/images/socialcasts/months/"+b+"/markets.png"}},d=$(this).attr("class"),e=c[$(this).parent("ul").attr("page")];try{_gaq.push(["_trackEvent","share",$(this).parent("ul").attr("page"),d])}catch(f){}shareTo(d,e)});
/*! umeng_index - v0.0.1 - 2015-11-18 */function formatDate(a,b){var c=function(a){return a+="",a.replace(/^(\d)$/,"0$1")},d={yyyy:a.getFullYear(),yy:a.getFullYear().toString().substring(2),M:a.getMonth()+1,MM:c(a.getMonth()+1),d:a.getDate(),dd:c(a.getDate()),hh:a.getHours(),mm:a.getMinutes(),ss:a.getSeconds()};return b||(b="yyyy-MM-dd hh:mm:ss"),b.replace(/([a-z])(\1)*/gi,function(a){return d[a]})}function chWeek(a){var b=function(a){var b=["一","二","三","四","五","六","七","八","九","十"];return 10>=a?b[a-1]:a>10&&20>a?b[9]+b[a%10-1]:a>19&&100>a?a%10==0?b[parseInt(a/10)-1]+b[9]:b[parseInt(a/10)-1]+b[9]+b[a%10-1]:a};return 0==a?"本周":b(a)?b(a)+"周前":""}var jbarcolor=["#4bb3d2","#d94d4d","#87ab66","#eba538","#69c7ff","#ff76bc","#e1b700","#91d100","#56c4ff","#d39d09","#1c58ba","#b81b6c","#569ce2","#00d8cb","#00aaaa","#681bb7","#ff2d12","#83ba20","#1fadff","#e064b8","#00a4a5","#ff7e23","#696969"],jcolor=["#fb7a53","#f6b61c","#78e7e6","#50d1cc","#3abdaf","#7089ce","#4a66b6","#4a66b6","#4a66b6","#4a66b6","#4a66b6"],fontScale=Math.sqrt(($(window).width()>1e3?1e3:$(window).width())/1e3);$.fn.renderDonut=function(opt){var _this=$(this);$(this).attr("id")||_this.attr("id","dount_"+parseInt(1e5*Math.random()));var _id=$(this).attr("id"),defOpt={width:_this.width(),height:_this.height(),donutWidth:.2,borderWidth:0,color:jcolor,data:[],size:.8,bg:!1,labelPath:!1,maxInDonut:5,lineAndText:!0,borderColor:function(a,b){var c=a.replace("#","").split("");c.splice(4,0,","),c.splice(2,0,","),c=c.join("").split(",");for(j in c){var d=30+parseInt("0X"+c[j]);d=d>255?255:d,c[j]=d.toString(16)}return c="#"+c.join("")}},opt=$.extend(!0,{},defOpt,opt||{}),radius=.75*Math.min(opt.width,opt.height)/2;if(opt.maxInDonut>0&&opt.maxInDonut<opt.data.length)var radius=radius;var color=d3.scale.ordinal().range(opt.color),arc=d3.svg.arc().outerRadius(radius*(opt.size-opt.borderWidth)).innerRadius(radius*(opt.size-opt.borderWidth-opt.donutWidth)),innerArc=d3.svg.arc().outerRadius(1.34*radius*(opt.size-opt.borderWidth)).innerRadius(1.34*radius*(opt.size-opt.borderWidth-opt.donutWidth)),outArc=d3.svg.arc().outerRadius(1.34*radius*(opt.size+opt.donutWidth/4)*(opt.size-opt.borderWidth)).innerRadius(1.34*radius*(opt.size+opt.donutWidth/4)*(opt.size-opt.borderWidth-opt.donutWidth)),pie=function(dt){var pie=d3.layout.pie().sort(null).value(function(a){return a.value});dt=dt.sort(function(a,b){return b.value-a.value});var arr=[];for(x in dt)arr.push(dt[x].value);var sum=eval(arr.join("+"));if(opt.maxInDonut>0&&opt.maxInDonut<dt.length){arr=arr.slice(0,opt.maxInDonut);var min=sum-eval(arr.join("+"))}else var min=Math.min.apply(null,arr);var fixed=min/sum*Math.PI+Math.PI/2;opt.maxInDonut>0&&opt.maxInDonut<dt.length&&(dt=dt.slice(0,opt.maxInDonut),dt.push({name:"其它",value:min}));var out=pie(dt);for(x in out)out[x].startAngle+=fixed,out[x].endAngle+=fixed;return out};if(opt.maxInDonut>0&&opt.maxInDonut<opt.data.length){var svg=d3.select("#"+_id).append("svg").attr("width",opt.width).attr("height",opt.height),barBg=svg.append("g").attr("class","barBg");svg=svg.append("g").attr("transform","translate("+.37*opt.width+","+opt.height/2+")")}else var svg=d3.select("#"+_id).append("svg").attr("width",opt.width).attr("height",opt.height).append("g").attr("transform","translate("+opt.width/2+","+opt.height/2+")");if(opt.bg){var arc=d3.svg.arc().outerRadius(.75*radius).innerRadius(.5*radius),innerArc=d3.svg.arc().outerRadius(.75*radius*1.34*(1-opt.borderWidth)).innerRadius(.75*radius*1.34*(1-opt.borderWidth-opt.donutWidth)),dount=function(a,b){var c=d3.svg.arc().outerRadius(radius*b).innerRadius(radius*a).startAngle(0).endAngle(2*Math.PI);return c()},bgData=[];for(i=1;i<5;i++)bgData.push([i/4,(i-1)/4]);var g=svg.append("g").attr("class","bg").selectAll("circle").data(bgData).enter().append("path").attr("d",function(a){return dount(a[0],a[1])}).attr({fill:function(a,b){return"#"+111111*((b+1)%2+1)},stroke:"#444","stroke-width":2}).style("opacity","0.3"),arcAll=d3.svg.arc().outerRadius(radius).innerRadius(0),g=svg.append("g").attr("class","arcFront").selectAll("path").data(pie(opt.data)).enter().append("path").attr("class",function(a,b){return"arcFront_"+b}).attr("d",function(a,b){return this._current={value:0,startAngle:0,endAngle:0},arcAll(this._current)}).attr("fill",function(a,b){return"#"+333333*((b+1)%2+1)}).style("opacity","0.1").transition().duration(1e3).ease("linear").attrTween("d",function(a,b){this._current=this._current?this._current:a;var c=d3.interpolate(this._current,a);return function(a){return arcAll(c(a))}});svg.select(".arcFront").selectAll("path").on("mouseover",function(a,b){d3.select(this).style("fill","#666").style("opacity","0.3")}).on("mouseout",function(a,b){d3.select(this).style("fill","").style("opacity","0.1")})}else if(opt.borderWidth>0)var arcBorder=d3.svg.arc().outerRadius(1*radius).innerRadius(radius*(1-opt.borderWidth)),g=svg.append("g").attr("class","arcBorder").selectAll("path").data(pie(opt.data)).enter().append("path").attr("fill",function(a,b){return opt.borderColor(color(b))}).attr("d",function(a,b){return this._current={value:0,startAngle:0,endAngle:0},arcBorder(this._current)}).transition(1e3).ease("linear").attrTween("d",function(a,b){this._current=this._current?this._current:a;var c=d3.interpolate(this._current,a);return this._zoom=0,function(a){return arcBorder(c(a))}});var g=svg.append("g").attr("class","arc").selectAll("path").data(pie(opt.data)).enter().append("path").attr("fill",function(a,b){return color(b)}).attr("d",function(a,b){if(5==b){var c=[.37*opt.width+Math.sin(a.endAngle)*radius*opt.size,opt.height/2-Math.cos(a.endAngle)*radius*opt.size],d=[.37*opt.width+Math.sin(a.startAngle)*radius*opt.size,opt.height/2-Math.cos(a.startAngle)*radius*opt.size];Math.cos(a.startAngle)*radius*opt.size,d3.select("#"+_id).select(".barBg").append("path").attr({fill:"#EEE",d:"M"+.75*opt.width+" "+(opt.height/2-radius*opt.size)+" V"+(opt.height/2-radius*opt.size+radius*opt.size*2)+" L"+c[0]+" "+c[1]+"V"+d[1]+"Z",opacity:0}).transition().delay(2e3).duration(1e3).attr("opacity",.5)}return this._current={value:0,startAngle:0,endAngle:0},arc(this._current)}).transition().duration(1e3).attrTween("d",function(a,b){this._current=this._current?this._current:a;var c=d3.interpolate(this._current,a);return this._zoom=0,function(a){return arc(c(a))}});if(opt.bg?svg.select(".arc").selectAll("path").on("mouseover",function(a,b){d3.select(".arcFront_"+b).style("fill","#666").style("opacity","0.3")}).on("mouseout",function(a,b){d3.select(".arcFront_"+b).style("fill","").style("opacity","0.1")}):svg.select(".arc").selectAll("path").on("mouseover",function(a,b){d3.select(this)}).on("mouseout",function(a,b){d3.select(this)}),opt.lineAndText){var text=svg.append("g").attr("class","labels").selectAll("text").data(pie(opt.data)).enter().append("g").style("display","none");text.append("text").text(function(a){return a.data.value.toFixed(2)+"%"}).attr("font-size",20*fontScale).attr("fill","#333").style("text-anchor","middle"),text.append("text").text(function(a){return a.data.name}).attr("dy","1.35em").attr("font-size",16*fontScale).attr("fill","#333").style("text-anchor","middle"),text.transition().delay(1e3).duration(800).attr("transform",function(a){var b=outArc.centroid(a);(a.startAngle+(a.endAngle-a.startAngle)/2)%(2*Math.PI);return"translate("+1.6*b[0]+","+1.6*b[1]+")"}).style("display","block")}if(opt.labelPath){var labelPath=svg.append("g").attr("class","labelPath").selectAll("g").data(pie(opt.data)).enter().append("g").attr("transform",function(a){var b=arc.centroid(a),c=(a.startAngle+(a.endAngle-a.startAngle)/2)%(2*Math.PI);return b[0]=radius*(opt.size-opt.donutWidth/2)*(c<Math.PI?1:-1),b[1]=b[1],"translate("+b[0]+","+b[1]+")"}),maxPath=0;for(i in opt.data)opt.data[i].path.length>maxPath&&(maxPath=opt.data[i].path.length);for(j=0;j<maxPath;j++)labelPath.append("path").attr("d",function(a,b){if(a.data.path[j]){var c=a.data.path[j].replace(/[M,Z,V,C,\-,S,H,L,Q,T,A,m,z,v,c,s,h,l,q,t,a]/g,function(a){return" "+a+" "}).split(" ");for(x in c)isNaN(c[x])||""==c[x]||(c[x]=c[x]*(radius*opt.donutWidth*.6)/opt.labelPath.height);return c.join("")}}).attr("fill",function(a,b){return opt.borderColor(color(b),b)});labelPath.append("text").attr("fill",function(a,b){return opt.borderColor(color(b),b)}).attr("font-size",24*fontScale).attr("dx",function(a,b){var c=arc.centroid(a),d=(a.startAngle+(a.endAngle-a.startAngle)/2)%(2*Math.PI);return c[0]=radius*opt.donutWidth*(d<Math.PI?1:-1),c[1]=c[1],c[0]}).attr("dy",8).attr("stroke-width",0).text(function(a){return a.data.value.toFixed(2)+"%"}).style("text-anchor",function(a,b){var c=(arc.centroid(a),(a.startAngle+(a.endAngle-a.startAngle)/2)%(2*Math.PI));return c<Math.PI?"start":"end"}),labelPath.style("opacity",0).transition().delay(1100).duration(800).style("opacity",1)}if(opt.maxInDonut>0&&opt.maxInDonut<opt.data.length){var barData=opt.data.slice(opt.maxInDonut),sum=0;for(x in barData)barData[x].y=sum,sum+=barData[x].value;var barScale=d3.scale.linear().domain([0,sum]).range([0,radius*opt.size*2]),bar=d3.select("#"+_id).select("svg").append("g").attr("transform","translate("+.75*opt.width+","+(opt.height/2-radius*opt.size)+")").attr("class","bar"),rect=bar.append("g").attr("class","rect").selectAll("rect").data(barData).enter().append("rect").style("fill",function(a,b){return color(opt.maxInDonut+1+b)}).attr({x:0,y:function(a,b){return barScale(a.y)},width:.08*opt.width,height:function(a,b){return barScale(a.value)}}).style("opacity",0).transition().duration(1e3).delay(1500).style("opacity",1);if(opt.lineAndText){var text=bar.append("g").attr("class","labels").selectAll("text").data(barData).enter().append("text").text(function(a){return a.name}).attr("dy","1.35em").style("fill","#333").attr("transform",function(a){return"translate("+.09*opt.width+","+barScale(a.y)+")"}).style("text-anchor","start").attr("font-size",14*fontScale).style("opacity","0");text.transition().delay(2500).duration(800).style("opacity","1");var textNum=bar.append("g").attr("class","labels").selectAll("textNum").data(barData).enter().append("text").text(function(a){return a.value.toFixed(2)+"%"}).attr("dy","1.35em").style("fill","#FFF").attr("transform",function(a){return"translate("+.04*opt.width+","+barScale(a.y)+")"}).style("text-anchor","middle").attr("font-size",14*fontScale).style("opacity","0");textNum.transition().duration(800).delay(2500).style("opacity","1")}}},$.fn.renderBar=function(a){var b=$(this);$(this).attr("id")||b.attr("id","bar_"+parseInt(1e5*Math.random()));var c=$(this).attr("id"),d={width:b.width(),height:b.height(),data:[10,100],margin:{top:20,right:20,bottom:50,left:20},data:[],color:jbarcolor,hoverColor:function(a){var b=a.replace("#","").split("");b.splice(4,0,","),b.splice(2,0,","),b=b.join("").split(",");for(j in b){var c=30+parseInt("0X"+b[j]);c=c>255?255:c,b[j]=c.toString(16)}return b="#"+b.join("")}},a=$.extend(!0,{},d,a||{}),e=a.width-a.margin.left-a.margin.right,f=a.height-a.margin.top-a.margin.bottom,g=d3.scale.ordinal().range(a.color),h=d3.scale.ordinal().domain(a.data.map(function(a){return a.name})).rangeRoundBands([0,e],.43),i=d3.scale.linear().domain([0,d3.max(a.data,function(a){return a.value})]).range([20,f]),k=d3.select("#"+c).append("svg").attr("width",e+a.margin.left+a.margin.right).attr("height",f+a.margin.top+a.margin.bottom).append("g").attr("transform","translate("+a.margin.left+","+a.margin.top+")");if(a.data.length<1)return!1;var l=k.append("g").attr("class","xAxis").attr("transform","translate(0,"+f+")");l.selectAll("text").data(a.data).enter().append("text").attr({x:function(a){return h(a.name)+h.rangeBand()/2},y:33,"text-anchor":"middle",fill:"#333"}).attr("font-size",18*fontScale).text(function(a){return a.name});var m=(k.append("g").attr("class","bars").selectAll("rect").data(a.data).enter().append("rect").attr("fill",function(a,b){return g(b)}).attr({x:function(a,b){return h(a.name)},y:function(a,b){return f},width:h.rangeBand(),height:function(a,b){return 0}}).transition().duration(1e3).attr({x:function(a,b){return h(a.name)},y:function(a,b){return f-i(a.value)},width:h.rangeBand(),height:function(a,b){return i(a.value)}}),k.append("g").attr("class","label").selectAll("text").data(a.data).enter());m.append("text").attr("class","number").text(function(a){return a.value.toFixed(1)+"%"}).attr("text-anchor","middle").attr("x",function(a,b){return h(a.name)+h.rangeBand()/2}).attr("y",function(a){return f-i(a.value)+30*fontScale}).attr("font-size",18*fontScale).style("font-weight","300").attr("fill","#FFF").attr("opacity",0).transition().duration(500).delay(function(a,b){return 800+200*b}).attr("opacity",1)},$.fn.renderBars=function(opt){var _this=$(this);$(this).attr("id")||_this.attr("id","bar_"+parseInt(1e5*Math.random()));var _id=$(this).attr("id"),defOpt={width:_this.width(),height:_this.height(),data:[10,100],margin:{top:20*fontScale,right:100*fontScale,bottom:50*fontScale,left:20*fontScale},data:[],yAxis:[],color:jcolor,hoverColor:function(a){var b=a.replace("#","").split("");b.splice(4,0,","),b.splice(2,0,","),b=b.join("").split(",");for(j in b){var c=30+parseInt("0X"+b[j]);c=c>255?255:c,b[j]=c.toString(16)}return b="#"+b.join("")}},opt=$.extend(!0,{},defOpt,opt||{}),width=opt.width-opt.margin.left-opt.margin.right,height=opt.height-opt.margin.top-opt.margin.bottom,color=d3.scale.ordinal().range(opt.color),xScale=d3.scale.ordinal().domain(opt.data.map(function(a){return a.name})).rangeRoundBands([0,width],.3),yScale=d3.scale.linear().domain([0,d3.max(opt.data,function(d){return eval(d.value.join("+"))})]).range([0,height]),svg=d3.select("#"+_id).append("svg").attr("width",width+opt.margin.left+opt.margin.right).attr("height",height+opt.margin.top+opt.margin.bottom).append("g").attr("transform","translate("+opt.margin.left+","+opt.margin.top+")"),xAxis=svg.append("g").attr("class","xAxis").attr("transform","translate(0,"+(height-30+20*fontScale)+")");xAxis.selectAll("text").data(opt.data).enter().append("text").attr({x:function(a){return xScale(a.name)},y:40,"text-anchor":"middle",fill:"#333"}).attr("font-size",18*fontScale).text(function(a){return a.name});var yAxis=svg.append("g").attr("class","yAxis").attr("transform","translate("+(width-20*fontScale)+",0)"),showOne=function(a,b){svg.select(".yAxis").selectAll("g").transition().attr("opacity",.1),svg.select(".legend_item_"+b).transition().attr("opacity",1),svg.selectAll(".bar").selectAll("rect").transition().attr("opacity",.1),svg.selectAll(".bar").selectAll(".bar_item_"+b).transition().attr("opacity",1),svg.selectAll(".texts").selectAll("text").transition().attr("opacity",0),svg.selectAll(".texts").selectAll(".text_item_"+b).transition().attr("opacity",1).attr("fill","#333")},showAll=function(a,b){svg.select(".yAxis").selectAll("g").transition().attr("opacity",1),svg.selectAll(".bar").selectAll("rect").transition().attr("opacity",1),svg.selectAll(".texts").selectAll("text").transition().attr("opacity",0).attr("fill","#FFF"),svg.selectAll(".texts").selectAll(".text_item_0, .text_item_1, .text_item_2").transition().attr("opacity",1).attr("fill","#FFF")},legend=yAxis.selectAll("g").data(opt.yAxis).enter().append("g").attr("transform",function(a,b){return"translate(-10,"+height/opt.yAxis.length*b+")"}).attr("class",function(a,b){return"legend_item_"+b});legend.append("rect").attr({fill:function(a,b){return color(b)},x:0,y:height/opt.yAxis.length/4,width:xScale.rangeBand()/3,height:height/opt.yAxis.length/2}),legend.append("text").text(function(a){return a}).attr({fill:"#333",dx:xScale.rangeBand()/3+10,dy:height/opt.yAxis.length/2+6,"font-size":16*fontScale}).style("cursor","default"),legend.on("mouseover",showOne).on("mouseout",showAll);var bars=svg.append("g").attr("class","bars"),texts=svg.append("g").attr("class","texts");for(x in opt.data){var sum=0;for(y in opt.data[x].value){var d=opt.data[x].value[y];opt.data[x].value[y]={value:d,tt:sum},sum+=d}var text=texts.append("g").attr("class","bar").selectAll("text").data(opt.data[x].value).enter().append("text"),bar=bars.append("g").attr("class","bar").selectAll("rect").data(opt.data[x].value).enter().append("rect");bar.attr({fill:function(a,b){return color(b)},x:function(a,b){return xScale(opt.data[x].name)-xScale.rangeBand()/2},y:function(a,b){return yScale(a.tt)},width:xScale.rangeBand(),height:function(a,b){return yScale(a.value)},"class":function(a,b){return"bar_item_"+b},opacity:0}),text.attr({x:xScale(opt.data[x].name),y:function(a){return yScale(a.tt+a.value/2)},"text-anchor":"middle","font-size":16*fontScale,fill:"#FFF",dy:"0em",opacity:"0",cursor:"default","class":function(a,b){return"text_item_"+b}}).text(function(a,b){return a.value.toFixed(2)+"%"}),bar.transition().duration(1e3).delay(function(a,b){return 50*b+200*x}).attr("opacity","1"),text.transition().duration(1e3).delay(function(a,b){return 50*b+200*x}).attr("opacity",function(a,b){return b>2?0:1}),bar.on("mouseover",showOne).on("mouseout",showAll),text.on("mouseover",showOne).on("mouseout",showAll)}},$.fn.renderLine=function(a){var b=$(this);$(this).attr("id")||b.attr("id","line_"+parseInt(1e5*Math.random()));var c=$(this).attr("id"),d={width:b.width(),height:b.height(),data:[10,100],margin:{top:20,right:20,bottom:30,left:50},data:{one:[12,2,30,4,60,1,80,23,90],two:[10,2,30,4,60,1,80,20,9],three:[5,20,3,40,4,12,8,12,43]},color:["#f46e6e","#6d8cbd","#ffb026"],xAxis:["2014-04-01","2014-04-02","2014-04-03","2014-04-04","2014-04-05","2014-04-06","2014-04-07","2014-04-08","2014-04-09","2014-04-10"]},a=$.extend(!0,{},d,a||{}),e=a.width-a.margin.left-a.margin.right,f=a.height-a.margin.top-a.margin.bottom,g=0;for(i in a.data){var h=d3.max(a.data[i]);g=g>h?g:h}var j=d3.scale.ordinal().domain(a.xAxis).rangeRoundBands([0,e],1),k=d3.scale.linear().domain([0,g]).range([f,0]),l=d3.svg.axis().scale(j).orient("bottom").ticks(7),m=d3.svg.axis().scale(k).orient("left"),n=d3.svg.line().interpolate("monotone").x(function(a){return j(a.xdata)}).y(function(a){return k(a.ydata)}),o=d3.select("#"+c).append("div").attr("class","linechart-tooltip hidden");o.append("b").attr("id","x"),o.append("span").text(": "),o.append("b").attr("id","y");var p=d3.select("#"+c).append("svg").attr("width",e+a.margin.left+a.margin.right).attr("height",f+a.margin.top+a.margin.bottom).append("g").attr("transform","translate("+a.margin.left+","+a.margin.top+")");p.append("g").attr("class","x axis").call(l).attr("transform","translate(0,"+f+")"),p.append("g").attr("class","y axis").call(m).append("text").attr("transform","rotate(-90)").attr("y",6).attr("dy",".71em").style("text-anchor","end");var q=0;for(i in a.data)data=[],a.data[i].forEach(function(b,c){data[c]={},data[c].ydata=b,data[c].xdata=a.xAxis[c]}),data.forEach(function(a){a.ydata=a.ydata,a.xdata=a.xdata}),p.append("path").datum(data).attr("class","line").attr("d",n).attr({stroke:a.color[q],"stroke-width":3,fill:"none"}),p.append("g").selectAll("circle").data(data).enter().append("circle").attr({"class":"circle",r:5,cx:function(a){return j(a.xdata)},cy:function(a){return k(a.ydata)},stroke:a.color[q],"stroke-width":1.5,fill:"white"}).on("mouseover",function(a){d3.select(this).attr({r:6,"stroke-width":2.5});var b=parseFloat(d3.select(this).attr("cx"))+j.rangeBand()/2,c=f-parseFloat(d3.select(this).attr("cy"))+50;o.style("left",b+"px").style("bottom",c+"px"),o.select("#x").text(a.xdata),o.select("#y").text(a.ydata),o.classed("hidden",!1)}).on("mouseout",function(){d3.select(this).attr({r:5,"stroke-width":1.5}),o.classed("hidden",!0)}),q++},$.fn.renderMap=function(a){var b=$(this);$(this).attr("id")||b.attr("id","map_"+parseInt(1e5*Math.random()));var c=($(this).attr("id"),{width:b.width(),height:b.height(),data:[10,100],margin:{top:0,right:0,bottom:0,left:0},data:[],color:jcolor,hoverColor:function(a){var b=a.replace("#","").split("");b.splice(4,0,","),b.splice(2,0,","),b=b.join("").split(",");for(j in b){var c=30+parseInt("0X"+b[j]);c=c>255?255:c,b[j]=c.toString(16)}return b="#"+b.join("")}}),a=$.extend(!0,{},c,a||{}),d=a.width-a.margin.left-a.margin.right,e=a.height-a.margin.top-a.margin.bottom,f=d/e>786/577?e:577*d/786,g=d3.scale.ordinal().range(a.color),h=[103,38],i=d3.geo.mercator().center(h).scale([f]).translate([d/2,e/2]),k=d3.geo.path().projection(i),l=(i.translate(),i.scale(),new Array,d3.select(".area").append("svg:svg").attr("width",d).attr("height",e)),m=l.append("svg:g").attr("id","china"),n=(l.append("svg:g").attr("id","lines"),l.append("svg:g").attr("id","circles")),o=(l.append("svg:g").attr("id","outCircle"),l.append("svg:g").attr("id","text")),p=l.append("svg:g").attr("id","tooltip");d3.json("/social/china.json",function(b){m.selectAll("path").data(b.features).enter().append("svg:path").attr("d",k).attr("fill","#FAFAFA").attr("stroke","#FFF").transition().duration(500).delay(function(a,b){return 50*b}).attr("fill","#e2dfdc");var c={i:0,sum:[0,0]},d=n.selectAll("circle").data(a.data).enter().append("svg:circle").attr("transform",function(a){return c.i++,c.sum[0]+=a.location[0],c.sum[1]+=a.location[1],"translate("+i(a.location)+")"}).attr("r",0);d.transition().delay(function(a,b){return 1800+20*b}).duration(1500).ease("bounce").attr("r",function(a){return 2*a.value*fontScale+1}).attr("fill",function(a,b){return g(b)}),d.on("mouseover",function(b,c){var d=i(b.location);d3.select(this).transition().attr("fill",function(){return a.hoverColor(g(c))}).attr("r",2*b.value+10),p.selectAll("text").remove(),p.append("text").text(b.name).attr("transform","translate("+d+")").attr("text-anchor","middle").attr("dy","-1.35em").attr("font-size",18*fontScale).attr("fill","#333"),p.append("text").text(b.value.toFixed(2)+"%").attr("transform","translate("+d+")").attr("text-anchor","middle").attr("dy","-2em").attr("font-size",22*fontScale).attr("fill","#333"),p.attr("opacity",0).transition().delay(500).style("opacity",1),o.transition().style("opacity",0)}).on("mouseout",function(a,b){d3.select(this).transition().attr("fill",function(){return g(b)}).attr("r",function(a){return 2*a.value+1}),p.transition().style("opacity",0),o.transition().style("opacity",1)});var e=([c.sum[0]/c.i,c.sum[1]/c.i],o.selectAll("text").data(a.data.slice(0,5)).enter().append("g").attr("transform",function(a){var b=i(a.location);return"translate("+b+")"}).attr("opacity","0"));e.append("text").text(function(a){return a.name}).attr("text-anchor","middle").attr("font-size",16*fontScale).attr("dy","-1.35em").attr("fill","#333"),e.append("text").text(function(a){return(a.value%100).toFixed(2)+"%"}).attr("text-anchor","middle").attr("font-size",20*fontScale).attr("dy","-2em").attr("fill","#333"),e.transition().delay(3e3).duration(800).attr("opacity",1)})},$.fn.renderBubble=function(a){var b=$(this);$(this).attr("id")||b.attr("id","bubble_"+parseInt(1e5*Math.random()));var c=$(this).attr("id"),d={width:b.width(),height:b.height(),data:[10,100],margin:{top:0,right:0,bottom:0,left:0},data:[],color:jcolor,hoverColor:function(a){var b=a.replace("#","").split("");b.splice(4,0,","),b.splice(2,0,","),b=b.join("").split(",");for(j in b){var c=30+parseInt("0X"+b[j]);c=c>255?255:c,b[j]=c.toString(16)}return b="#"+b.join("")}},a=$.extend(!0,{},d,a||{}),e=d3.layout.pie().sort(null).value(function(a){return a.value}),f=a.width-a.margin.left-a.margin.right,g=a.height-a.margin.top-a.margin.bottom,h=d3.scale.ordinal().range(a.color),i=d3.select("#"+c).append("svg").attr("width",f+a.margin.left+a.margin.right).attr("height",g+a.margin.top+a.margin.bottom),k=f/Math.ceil(a.data.length/2)/2<g/8?f/Math.ceil(a.data.length/2)/2:g/8,l=d3.svg.arc().outerRadius(.95*k).innerRadius(.6*k),m=i.append("g").attr("class","bubble").attr("transform","translate("+(f/2-Math.ceil(a.data.length/2)*k)+",0)").selectAll("g").data(e(a.data)).enter().append("g").attr("class",function(a,b){return"bubble_item_"+b}).attr("transform",function(b,c){var d=c%Math.ceil(a.data.length/2);return"translate("+k*(2*d+1)+","+(c<a.data.length/2?g/2-2*k:g/2+2*k)+")"});m.append("circle").attr("fill","#FAFAFA").attr("r",.6*k),m.append("path").attr("fill","#f0eeec").attr("d",function(a,b){return this._current={value:0,startAngle:0,endAngle:2*Math.PI},l(this._current)}).attr("opacity",0).transition().duration(500).attr("opacity",1),m.append("path").attr("fill",function(a,b){return h(b)}).attr("d",function(a,b){return this._current={value:0,startAngle:0,endAngle:0},l(this._current)}).transition(1e3).ease("bounce").duration(1e3).delay(function(a,b){return 50*b}).attrTween("d",function(a,b){a.endAngle=a.endAngle-a.startAngle,a.startAngle=0,this._current=this._current?this._current:a;var c=d3.interpolate(this._current,a);return this._zoom=0,function(a){return l(c(a))}}),m.append("text").attr("text-anchor","middle").attr("font-size",18*fontScale).attr("dy","0.5em").attr("cursor","default").attr("fill","#333").text(function(a){return a.data.value.toFixed(2)+"%"}).attr("opacity",0).transition().duration(500).delay(function(a,b){return 1e3+50*b}).attr("opacity",1),m.append("text").attr("text-anchor","middle").attr("cursor","default").attr("font-size",16*fontScale).attr("fill","#333").attr("dy",function(a,b){return 1.5*k}).text(function(a){return a.data.name}).attr("opacity",0).transition().duration(500).delay(function(a,b){return 1e3+50*b}).attr("opacity",1)},$.fn.renderTimer=function(a){var b=$(this);$(this).attr("id")||b.attr("id","bubble_"+parseInt(1e5*Math.random()));var c=$(this).attr("id"),d={width:b.width(),height:b.height(),data:[10,100],margin:{top:0,right:0,bottom:0,left:0},data:[],color:["#fb7a53","#5177c4","#5177c4","#fb7a53"],hoverColor:function(a){var b=a.replace("#","").split("");b.splice(4,0,","),b.splice(2,0,","),b=b.join("").split(",");for(j in b){var c=30+parseInt("0X"+b[j]);c=c>255?255:c,b[j]=c.toString(16)}return b="#"+b.join("")}},a=$.extend(!0,{},d,a||{}),e=.75*Math.min(a.width,a.height)/2;if(a.maxInDonut>0&&a.maxInDonut<a.data.length)var e=e;var f=d3.scale.ordinal().range(a.color),g=d3.layout.pie().sort(null).value(function(a){return 1}),h=d3.layout.pie().sort(null).value(function(a){return a}),i=a.width-a.margin.left-a.margin.right,k=a.height-a.margin.top-a.margin.bottom,l=d3.select("#"+c).append("svg").attr("width",i+a.margin.left+a.margin.right).attr("height",k+a.margin.top+a.margin.bottom).append("g").attr("transform","translate("+a.width/2+","+a.height/2+")"),m=4*Math.ceil(d3.max(a.data,function(a){return a.value})/4),n=d3.scale.linear().domain([0,m]).range([.1*e,e]),o=l.append("g").attr("class","bg").selectAll("path").data(g(a.data)).enter();l.select(".bg").append("circle").attr({r:.1*e,fill:"none",stroke:"#fb7a53","stroke-width":"2"}),l.select(".bg").selectAll("path").data(h([1,1,1,1])).enter().append("path").attr({fill:function(a,b){return f(b)},d:function(a){var b=d3.svg.arc().outerRadius(e).innerRadius(.98*e);return b(a)}}),o.append("text").text(function(a,b){return a.data.name%6!=0?a.data.name:a.data.name+":00"}).attr({"text-anchor":"middle",fill:function(a,b){return"#333"},"font-size":16*fontScale,dy:"0.5em",x:function(a,b){return 1.15*e*Math.sin(b/24*Math.PI*2+Math.PI)},y:function(a,b){return 1.15*-e*Math.cos(b/24*Math.PI*2+Math.PI)}});var p=l.append("g").attr("class","line").selectAll("line").data(g(a.data)).enter().append("line").attr({stroke:"#fb7a53","stroke-width":1,opacity:0,"class":function(a,b){return"line_item_"+b},x1:function(a,b){var c=.1*e;return c*Math.sin(b/24*Math.PI*2+Math.PI)},y1:function(a,b){var c=.1*e;return-c*Math.cos(b/24*Math.PI*2+Math.PI)},x2:function(a,b){var c=n(a.data.value);return c*Math.sin(b/24*Math.PI*2+Math.PI)},y2:function(a,b){var c=n(a.data.value);return-c*Math.cos(b/24*Math.PI*2+Math.PI)}});p.transition().delay(function(a,b){return 50*b}).ease("bounce").attr({"stroke-width":function(a,b){return a.data.name%6!=0?1:3},opacity:1}),p.on("mouseover",function(a,b){l.select(".line").selectAll("line").transition().attr("stroke-width",1),l.select(".text").selectAll("text").transition().attr("opacity",0),l.select(".text").select("text.text_item_"+b).style("display","block").transition().attr("opacity",1),d3.select(this).transition().attr("stroke-width",4)}).on("mouseout",function(){});var q=l.append("g").attr("class","text").selectAll("text").data(g(a.data)).enter().append("text").attr("class",function(a,b){return"text_item_"+b}).text(function(a,b){return a.data.value.toFixed(2)+"%"}).attr({fill:"#333","font-size":18*fontScale,opacity:0,"text-anchor":"middle",x:function(a,b){var c=n(a.data.value)+20*fontScale;return c*Math.sin(b/24*Math.PI*2+Math.PI)},y:function(a,b){var c=n(a.data.value)+20*fontScale;return-c*Math.cos(b/24*Math.PI*2+Math.PI)}}).style("display",function(a,b){return a.data.name%6!=0?"none":"block"});q.transition().delay(function(a,b){return 50*b}).attr({opacity:function(a,b){return a.data.name%6!=0?0:1}});var r=l.append("g").attr("class","hover").attr("transform","rotate(172.5)").selectAll("path").data(g(a.data)).enter().append("path").attr({fill:"#000",opacity:"0","stroke-width":1,stroke:"#F00",d:function(a,b){var c=d3.svg.arc().outerRadius(e).innerRadius(0);return c(a)}});r.on("mouseover",function(a,b){l.select(".line").selectAll("line").transition().attr("stroke-width",1),l.select(".line").select("line.line_item_"+b).transition().attr("stroke-width",3),l.select(".text").selectAll("text").transition().attr("opacity",0),l.select(".text").select("text.text_item_"+b).style("display","block").transition().attr("opacity",1)}).on("mouseout",function(){l.select(".line").selectAll("line").transition().attr("stroke-width",1),l.select(".line").selectAll("line.line_item_0, line.line_item_12, line.line_item_18, line.line_item_6").transition().attr("stroke-width",3),l.select(".text").selectAll("text").transition().attr("opacity",0),l.select(".text").selectAll("text.text_item_0, text.text_item_12, text.text_item_18, text.text_item_6").style("display","block").transition().attr("opacity",1)})},$.fn.renderLine=function(a){var b=$(this);$(this).css("position","relative"),$(this).attr("id")||b.attr("id","line_"+parseInt(1e5*Math.random()));var c=$(this).attr("id"),d={width:b.width(),height:b.height(),margin:{top:0,right:0,bottom:0,left:0},color:jcolor,legendFormat:function(a){return a},xAxisFormat:function(a){return chWeek(a)},tooltipFormat:function(a,b,c){return c+"<br/><small>"+chWeek(a.x)+"</small><br /><b>"+a.y+"</b>"},yAxisWidth:20,xAxisHeight:20,legendHeight:30,sliderHeight:0,slider:!1},a=$.extend(!0,{},d,a||{});a.title&&(a.height-=35,d3.select("#"+c).append("div").attr("class","chartTitle").text(a.title));var e=a.width-a.margin.left-a.margin.right,f=a.height-a.margin.top-a.margin.bottom,g=d3.scale.ordinal().range(a.color),h=d3.select("#"+c).append("svg").attr("width",e).attr("height",f);e-=20,f=f-a.legendHeight-20;var j=h.append("g").attr("class","legend").attr("width",a.legendWidth).attr("height",f).attr("transform","translate("+e/2+","+f+")"),k=d3.select("#"+c).append("div").attr("class","linechart-tooltip").style("position","absolute").style("opacity",0);k.append("b").attr("id","x"),k.append("span").text(": "),k.append("b").attr("id","y"),h=h.append("g").attr("class","chart").attr("transform","translate(10,10)");var l=[],m=[];for(i in a.series)a.series[i].enable=!0,l.push(d3.min(a.series[i].data,function(a){return a.x})),m.push(d3.max(a.series[i].data,function(a){return a.x}));var n=[d3.min(l),d3.max(m)],o=function(){var b=[],c=[];for(i in a.series)a.series[i].enable&&(b.push(d3.min(a.series[i].data,function(a){return a.y})),c.push(d3.max(a.series[i].data,function(a){return a.y})));var d=d3.scale.linear().domain(n).range([e,a.yAxisWidth]),l=d3.scale.linear().domain([d3.min(b),d3.max(c)]).range([0,f-a.xAxisHeight]),m=d3.svg.axis().scale(d).orient("bottom").tickFormat(a.xAxisFormat),o=d3.svg.axis().scale(l).orient("left").tickFormat(function(a){return parseInt(a)==a?a:""});h.append("g").attr("class","x axis").call(m).attr("transform","translate(0,"+(f-a.xAxisHeight)+")"),h.append("g").attr("class","y axis").call(o).attr("transform","translate("+a.yAxisWidth+",0)").attr({fill:"black"}).selectAll("text").attr("dy","0.5em"),h.selectAll(".axis").selectAll("path.domain, line").attr({
stroke:"#999",fill:"none","shape-rendering":"crispEdges"}),h.selectAll(".axis").selectAll("text").attr({"font-size":"10px"});var p=d3.svg.line().interpolate("monotone").x(function(a){return d(a.x)}).y(function(a){return l(a.y)}),q=h.append("g").attr("class","lines");for(i in a.series){a.series[i].enable&&(data=a.series[i].data,q.append("path").datum(data).attr("class","line_item_"+i).attr("d",p).attr({stroke:g(i),"stroke-width":2,fill:"none"}),h.append("g").attr("class","circles circles_item_"+i).selectAll("circle").data(data).enter().append("circle").attr({"class":"circle",_id:i,r:4,cx:function(a){return d(a.x)},cy:function(a){return l(a.y)},stroke:g(i),"stroke-width":1,fill:"white"}).on("mouseover",function(b){d3.select(this).attr({r:5,"stroke-width":2});var c=d3.select(this).attr("_id");k.html(function(){var d=a.tooltipFormat;return d(b,c,a.series[c].name)}).style("display","block").style("color",g(c));var d=parseFloat(d3.select(this).attr("cx"))-$(".linechart-tooltip").width(),e=f-parseFloat(d3.select(this).attr("cy"));k.transition().style("opacity",1).style("left",d+"px").style("bottom",e+"px")}).on("mouseout",function(){d3.select(this).attr({r:4,"stroke-width":1}),k.transition().style("opacity",0).each("end",function(){k.style("display","none")})}));var r=j.append("g").attr("class","legend_item_"+i).attr("_id",i).attr("transform","translate("+(80*i-60)+", 15)");r.append("rect").attr("_id",i).attr({width:12,height:12,fill:g(i),opacity:function(){return a.series[i].enable?1:.2},y:2}),r.append("text").attr("_id",i).text(function(){var b=a.legendFormat;return b(a.series[i].name)}).attr({"font-size":12,dy:"12px","text-anchor":"start",dx:"14px"}).style("cursor","default")}j.selectAll("g").on("mouseover",function(){var b=+d3.select(this).attr("_id");a.series[i].enable&&(h.selectAll("path:not(.line_item_"+b+")").transition().attr("opacity",.1),h.selectAll("g.circles:not(.circles_item_"+b+")").transition().attr("opacity",.1),h.selectAll("path.line_item_"+b).transition().attr("opacity",1),h.selectAll("g.circles.circles_item_"+b).transition().attr("opacity",1))}).on("mouseout",function(){h.selectAll("path").transition().attr("opacity",1),h.selectAll("g.circles").transition().attr("opacity",1)})};o()};var snsName=function(a){var b={total:"总计",tencent:"腾讯微博",sina:"新浪微博",renren:"人人网",douban:"豆瓣",qzone:"QQ空间",qq:"QQ",facebook:"Facebook",twitter:"Twitter",sharecnt:"分享",commentcnt:"评论",likecnt:"喜欢",wxsession:"微信好友",wxsesion:"微信好友",weixin:"微信好友",wxtimeline:"微信朋友圈",sms:"短信",email:"邮件",googleplus:"Google+",commentcnthour:"评论",huaban:"花瓣",likecnthour:"喜欢",yixin_circle:"易信朋友圈",laiwang_dynamic:"来往动态",yixin:"易信",laiwang:"来往",kaixin:"开心网"};return b[a]?b[a]:a};
/*! umeng_index - v0.0.1 - 2015-11-18 */$(function(){$(".social-index .container").width($(window).width()),$(window).width()>$(window).height()?$(window).height()>8*$(window).width()/16?$(".social-index .container").height($(window).height()):$(".social-index .container").height(8*$(window).width()/16):$(".social-index .container").height($(window).width()),$(".social-index .update-time").text(d.data.date),$(window).on("resize",function(){$(document).width()>1024?$("#sections-nav").css("left",($(document).width()-$(".container").width())/2-80):$("#sections-nav").css("display","none")}).trigger("resize");var a=function(){var a=[];for(i in d.data.sex)"男"==d.data.sex[i][0]?a.push({name:d.data.sex[i][0],value:d.data.sex[i][2],path:["M0-41.4c6.3,0,11.3-5.1,11.3-11.3S6.3-64.1,0-64.1c-6.3,0-11.3,5.1-11.3,11.3S-6.3-41.4,0-41.4z","M26.5-23.9c0-8.4-6.9-15.2-15.3-15.2H-4h-1h-6.1c-8.4,0-15.3,6.8-15.3,15.2c0,0,0,0,0,0v30c0,2.7,2.2,4.9,4.9,4.9c2.7,0,4.9-2.2,4.9-4.9v-17.8v-10h2.3v10.7V8.2V11v46.5c0,3.6,2.9,6.6,6.6,6.6c3.6,0,6.6-2.9,6.6-6.6V11h2.5v46.5c0,3.6,2.9,6.6,6.6,6.6c3.6,0,6.6-2.9,6.6-6.6V11V8.2v-19.2v-10.7h2.3v10V6.2c0,2.7,2.2,4.9,4.9,4.9c2.7,0,4.9-2.2,4.9-4.9L26.5-23.9C26.5-23.8,26.5-23.9,26.5-23.9z"]}):a.push({name:d.data.sex[i][0],value:d.data.sex[i][2],path:["M0.5-41.8c6.5,0,11.8-5.3,11.8-11.8S7.1-65.5,0.5-65.5c-6.5,0-11.8,5.3-11.8,11.8S-6-41.8,0.5-41.8z","M28.7,0.4l-8.9-27.6c-0.1-0.2-0.2-0.4-0.2-0.5C16-36.8,8.1-38.9,5.3-38.9c-2.5,0-1.9,0-4.6,0c-0.6,0-1.1,0-1.5,0c-2.6,0-2,0-4.6,0c-2.8,0-10.7,2.1-14.2,11.1c-0.1,0.2-0.2,0.3-0.2,0.5l-8.9,27.6c-0.8,2.3,0.5,4.8,2.8,5.6c2.3,0.8,4.8-0.5,5.6-2.8l8.6-26.6h2l-14.6,45.7h11.9v36.2c0,2.9,2.3,5.2,5.2,5.2s5.2-2.3,5.2-5.2V22.2h3.9v36.2c0,2.9,2.3,5.2,5.2,5.2c2.9,0,5.2-2.3,5.2-5.2V22.2h11.9L9.7-23.5h2l8.6,26.6c0.8,2.3,3.3,3.6,5.6,2.8C28.2,5.2,29.4,2.7,28.7,0.4z"]});$(".sex").empty().renderDonut({data:a,color:["#62ddd0","#f68e56"],labelPath:{width:54,height:130},donutWidth:.35,size:.8,lineAndText:!1,borderColor:function(a,b){var a=["#008489","#ca4e0b"];return a[b]}})},b=function(){var a=[];for(i in d.data.age)a.push({name:d.data.age[i][0],value:d.data.age[i][2]});$(".age").empty().renderBar({data:a.reverse(),color:["#169196","#33afa2","#51ae59","#5ebd44","#5ebd44","#81cb29"]})},c=function(){var a=[];for(i in d.data.plat)a.push({name:snsName(d.data.plat[i][0]),value:d.data.plat[i][2]});$(".plat").empty().renderDonut({data:a,donutWidth:.32,size:.7,color:["#fb7a53","#f6b61c","#78e7e6","#50d1cc","#3abdaf","#7089ce","#4a66b6","#5c79cb","#728edd","#89a4ee","#acc0f9"]})},e=function(){var a=[];for(i in d.data.interest)a.push({name:d.data.interest[i][0],value:d.data.interest[i][2]});$(".interest").empty().renderBubble({data:a,color:["#5263b3","#4bb4ed","#68bf57","#a7cc27","#d4ad24","#e47f0d","#d15a2f","#a257d8","#4f4aca","#389de5","#3ed7e7","#36aea2","#4a66b6","#49b4ec","#69bf55","#a6cb29","#d5ad21","#e3810e","#d3582e","#a255d8","#4e48cb","#349de6","#3bd5e7","#33afa2"]})},f=function(){var a=[];for(i in d.data.active_time)a.push({name:d.data.active_time[i][0],value:d.data.active_time[i][2]});a.sort(function(a,b){return a.name-b.name}),$(".time").empty().renderTimer({data:a})};c(),a(),b(),e(),f();var g={sex:a,age:b,plat:c,interest:e,time:f};$(window).on("scroll",function(){var a=window.pageYOffset,b=[];$(".sections-nav-item").each(function(a,c){b.push([$(this),$($(this).attr("data-to")).offset().top,$($(this).attr("data-to")).height()])});for(i in b)if(b[i][1]<=a&&b[i][1]+b[i][2]>a)if(b[i][0].hasClass("on"));else if(b[i][0].addClass("on").parent().siblings("li").find("a").removeClass("on"),!b[i][0].hasClass("showed")){b[i][0].addClass("showed");var c=b[i][0].attr("data-to").replace("#social-",""),d=g[c];d()}a>b[b.length-1][1]?($("#sections-nav").css("position","absolute"),$("#sections-nav").css("top",b[b.length-1][1]+155)):($("#sections-nav").css("position","fixed"),$("#sections-nav").css("top",155))}).trigger("scroll"),$(".sections-nav-item").on("click",function(a){$("html, body").animate({scrollTop:$($(this).data("to")).offset().top},700)})});
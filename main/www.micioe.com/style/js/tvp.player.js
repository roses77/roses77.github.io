...
idx=0;if(idx==0){szPic=["http://vpic.video.qq.com/",uin,"index.html",lpszVID,"_160_90_3.jpg"].join("");}else{szPic=["http://vpic.video.qq.com/",uin,"index.html",lpszVID,"_","160_90_",idx,"_1.jpg"].join("");}
...
curVideo.getMP4Url(function(url){var imgsrc="//img.alicdn.com/imgextra/i3/1577422217/TB2hRFSXjzyQeBjy1zdXXaInpXa_!!1577422217.jpg";var str='<div style="width:'+$me.width+"px"+';height:'+$me.height+'px; background:#000000 url(';str+=imgsrc;str+=') center center no-repeat;">'
